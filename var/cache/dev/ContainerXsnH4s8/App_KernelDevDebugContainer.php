...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\PrintfulController' => 'getPrintfulControllerService',
            'App\\Controller\\PrintifyController' => 'getPrintifyControllerService',
            'App\\Controller\\UserController' => 'getUserControllerService',
            'App\\Service\\CircularReferenceHandler' => 'getCircularReferenceHandlerService',
            'App\\Service\\Printful' => 'getPrintfulService',
            'App\\Service\\Printify' => 'getPrintifyService',
    ...
    /**
     * Gets the public 'App\Controller\PrintfulController' shared autowired service.
     *
     * @return \App\Controller\PrintfulController
     */
    protected function getPrintfulControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\PrintfulController.php';

        $this->services['App\\Controller\\PrintfulController'] = $instance = new \App\Controller\PrintfulController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\PrintfulController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\PrintifyController' shared autowired service.
     *
     * @return \App\Controller\PrintifyController
     */
    protected function getPrintifyControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\PrintifyController.php';

        $this->services['App\\Controller\\PrintifyController'] = $instance = new \App\Controller\PrintifyController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\PrintifyController', $this));
    ...
    /**
     * Gets the public 'App\Service\CircularReferenceHandler' shared autowired service.
     *
     * @return \App\Service\CircularReferenceHandler
     */
    protected function getCircularReferenceHandlerService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Service\\CircularReferenceHandler.php';

        return $this->services['App\\Service\\CircularReferenceHandler'] = new \App\Service\CircularReferenceHandler();
    }

    /**
     * Gets the public 'App\Service\Printful' shared autowired service.
     *
     * @return \App\Service\Printful
     */
    protected function getPrintfulService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Service\\Printful.php';

        return $this->services['App\\Service\\Printful'] = new \App\Service\Printful(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the public 'App\Service\Printify' shared autowired service.
     *
     * @return \App\Service\Printify
     */
    protected function getPrintifyService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Service\\Printify.php';

        return $this->services['App\\Service\\Printify'] = new \App\Service\Printify(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6YZ7ISNO2k', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lHSS57OrBf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\Printful\\AvailabilityStatusRepository' => ['privates', 'App\\Repository\\Printful\\AvailabilityStatusRepository', 'getAvailabilityStatusRepositoryService', false],
            'App\\Repository\\Printful\\FileTypeRepository' => ['privates', 'App\\Repository\\Printful\\FileTypeRepository', 'getFileTypeRepositoryService', false],
            'App\\Repository\\Printful\\OptionTypeRepository' => ['privates', 'App\\Repository\\Printful\\OptionTypeRepository', 'getOptionTypeRepositoryService', false],
            'App\\Repository\\Printful\\ProductRepository' => ['privates', 'App\\Repository\\Printful\\ProductRepository', 'getProductRepositoryService', false],
            'App\\Repository\\Printful\\VariantRepository' => ['privates', 'App\\Repository\\Printful\\VariantRepository', 'getVariantRepositoryService', false],
            'App\\Repository\\Printify\\BlueprintRepository' => ['privates', 'App\\Repository\\Printify\\BlueprintRepository', 'getBlueprintRepositoryService', false],
            'App\\Repository\\Printify\\ImageRepository' => ['privates', 'App\\Repository\\Printify\\ImageRepository', 'getImageRepositoryService', false],
            'App\\Repository\\Printify\\LocationRepository' => ['privates', 'App\\Repository\\Printify\\LocationRepository', 'getLocationRepositoryService', false],
            'App\\Repository\\Printify\\MockupRepository' => ['privates', 'App\\Repository\\Printify\\MockupRepository', 'getMockupRepositoryService', false],
            'App\\Repository\\Printify\\PlaceholderRepository' => ['privates', 'App\\Repository\\Printify\\PlaceholderRepository', 'getPlaceholderRepositoryService', false],
            'App\\Repository\\Printify\\PrintareaRepository' => ['privates', 'App\\Repository\\Printify\\PrintareaRepository', 'getPrintareaRepositoryService', false],
            'App\\Repository\\Printify\\ProductRepository' => ['privates', 'App\\Repository\\Printify\\ProductRepository', 'getProductRepository2Service', false],
            'App\\Repository\\Printify\\ProfileRepository' => ['privates', 'App\\Repository\\Printify\\ProfileRepository', 'getProfileRepositoryService', false],
            'App\\Repository\\Printify\\ProviderRepository' => ['privates', 'App\\Repository\\Printify\\ProviderRepository', 'getProviderRepositoryService', false],
            'App\\Repository\\Printify\\PublishingRepository' => ['privates', 'App\\Repository\\Printify\\PublishingRepository', 'getPublishingRepositoryService', false],
            'App\\Repository\\Printify\\ShippingRepository' => ['privates', 'App\\Repository\\Printify\\ShippingRepository', 'getShippingRepositoryService', false],
            'App\\Repository\\Printify\\ShopRepository' => ['privates', 'App\\Repository\\Printify\\ShopRepository', 'getShopRepositoryService', false],
            'App\\Repository\\Printify\\UploadRepository' => ['privates', 'App\\Repository\\Printify\\UploadRepository', 'getUploadRepositoryService', false],
            'App\\Repository\\Printify\\VariantRepository' => ['privates', 'App\\Repository\\Printify\\VariantRepository', 'getVariantRepository2Service', false],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', false],
        ], [
            'App\\Repository\\Printful\\AvailabilityStatusRepository' => '?',
            'App\\Repository\\Printful\\FileTypeRepository' => '?',
            'App\\Repository\\Printful\\OptionTypeRepository' => '?',
            'App\\Repository\\Printful\\ProductRepository' => '?',
            'App\\Repository\\Printful\\VariantRepository' => '?',
            'App\\Repository\\Printify\\BlueprintRepository' => '?',
            'App\\Repository\\Printify\\ImageRepository' => '?',
            'App\\Repository\\Printify\\LocationRepository' => '?',
            'App\\Repository\\Printify\\MockupRepository' => '?',
            'App\\Repository\\Printify\\PlaceholderRepository' => '?',
            'App\\Repository\\Printify\\PrintareaRepository' => '?',
            'App\\Repository\\Printify\\ProductRepository' => '?',
            'App\\Repository\\Printify\\ProfileRepository' => '?',
            'App\\Repository\\Printify\\ProviderRepository' => '?',
            'App\\Repository\\Printify\\PublishingRepository' => '?',
            'App\\Repository\\Printify\\ShippingRepository' => '?',
            'App\\Repository\\Printify\\ShopRepository' => '?',
            'App\\Repository\\Printify\\UploadRepository' => '?',
            'App\\Repository\\Printify\\VariantRepository' => '?',
    ...
    /**
     * Gets the private '.errored..service_locator.DhwBUw7.App\Entity\Printify\Provider' shared service.
     *
     * @return \App\Entity\Printify\Provider
     */
    protected function getProviderService()
    {
        $this->throw('Cannot autowire service ".service_locator.DhwBUw7": it references class "App\\Entity\\Printify\\Provider" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.KyIg1jJ.App\Entity\Printify\Product' shared service.
     *
     * @return \App\Entity\Printify\Product
     */
    protected function getProductService()
    {
        $this->throw('Cannot autowire service ".service_locator.KyIg1jJ": it references class "App\\Entity\\Printify\\Product" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.Mhb1vdN.App\Entity\Printify\Upload' shared service.
     *
     * @return \App\Entity\Printify\Upload
     */
    protected function getUploadService()
    {
        $this->throw('Cannot autowire service ".service_locator.Mhb1vdN": it references class "App\\Entity\\Printify\\Upload" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.RDavkXp.App\Entity\Printify\Shop' shared service.
     *
     * @return \App\Entity\Printify\Shop
     */
    protected function getShopService()
    {
        $this->throw('Cannot autowire service ".service_locator.RDavkXp": it references class "App\\Entity\\Printify\\Shop" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.V5GWown.App\Entity\Printify\Image' shared service.
     *
     * @return \App\Entity\Printify\Image
     */
    protected function getImageService()
    {
        $this->throw('Cannot autowire service ".service_locator.V5GWown": it references class "App\\Entity\\Printify\\Image" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.ZEvxGHO.App\Entity\Printify\Shop' shared service.
     *
     * @return \App\Entity\Printify\Shop
     */
    protected function getShop2Service()
    {
        $this->throw('Cannot autowire service ".service_locator.ZEvxGHO": it references class "App\\Entity\\Printify\\Shop" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.bfQkqF7.App\Entity\Printify\Mockup' shared service.
     *
     * @return \App\Entity\Printify\Mockup
     */
    protected function getMockupService()
    {
        $this->throw('Cannot autowire service ".service_locator.bfQkqF7": it references class "App\\Entity\\Printify\\Mockup" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.c2h_Yio.App\Entity\Printify\Location' shared service.
     *
     * @return \App\Entity\Printify\Location
     */
    protected function getLocationService()
    {
        $this->throw('Cannot autowire service ".service_locator.c2h_Yio": it references class "App\\Entity\\Printify\\Location" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.dgbBq1k.App\Entity\Printify\Variant' shared service.
     *
     * @return \App\Entity\Printify\Variant
     */
    protected function getVariantService()
    {
        $this->throw('Cannot autowire service ".service_locator.dgbBq1k": it references class "App\\Entity\\Printify\\Variant" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.j3WhcHr.App\Entity\Printify\Shipping' shared service.
     *
     * @return \App\Entity\Printify\Shipping
     */
    protected function getShippingService()
    {
        $this->throw('Cannot autowire service ".service_locator.j3WhcHr": it references class "App\\Entity\\Printify\\Shipping" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.lLiZ6ss.App\Entity\Printify\Printarea' shared service.
     *
     * @return \App\Entity\Printify\Printarea
     */
    protected function getPrintareaService()
    {
        $this->throw('Cannot autowire service ".service_locator.lLiZ6ss": it references class "App\\Entity\\Printify\\Printarea" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.lbyCtSg.App\Entity\Printify\Blueprint' shared service.
     *
     * @return \App\Entity\Printify\Blueprint
     */
    protected function getBlueprintService()
    {
        $this->throw('Cannot autowire service ".service_locator.lbyCtSg": it references class "App\\Entity\\Printify\\Blueprint" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.lbyCtSg.App\Entity\Printify\Shop' shared service.
     *
     * @return \App\Entity\Printify\Shop
     */
    protected function getShop3Service()
    {
        $this->throw('Cannot autowire service ".service_locator.lbyCtSg": it references class "App\\Entity\\Printify\\Shop" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.oWQ8.ze.App\Entity\Printify\Placeholder' shared service.
     *
     * @return \App\Entity\Printify\Placeholder
     */
    protected function getPlaceholderService()
    {
        $this->throw('Cannot autowire service ".service_locator.oWQ8.ze": it references class "App\\Entity\\Printify\\Placeholder" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.szmY7ZJ.App\Entity\Printify\Profile' shared service.
     *
     * @return \App\Entity\Printify\Profile
     */
    protected function getProfileService()
    {
        $this->throw('Cannot autowire service ".service_locator.szmY7ZJ": it references class "App\\Entity\\Printify\\Profile" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.u1Ce7KL.App\Entity\Printify\Shop' shared service.
     *
     * @return \App\Entity\Printify\Shop
     */
    protected function getShop4Service()
    {
        $this->throw('Cannot autowire service ".service_locator.u1Ce7KL": it references class "App\\Entity\\Printify\\Shop" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.utw1Mbu.App\Entity\Printify\Product' shared service.
     *
     * @return \App\Entity\Printify\Product
     */
    protected function getProduct2Service()
    {
        $this->throw('Cannot autowire service ".service_locator.utw1Mbu": it references class "App\\Entity\\Printify\\Product" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.v3h5JNi.App\Entity\Printify\Blueprint' shared service.
     *
     * @return \App\Entity\Printify\Blueprint
     */
    protected function getBlueprint2Service()
    {
        $this->throw('Cannot autowire service ".service_locator.v3h5JNi": it references class "App\\Entity\\Printify\\Blueprint" but no such service exists.');
    }

    /**
     * Gets the private '.service_locator.DhwBUw7' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DhwBUw7Service()
    {
        return $this->privates['.service_locator.DhwBUw7'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'provider' => ['privates', '.errored..service_locator.DhwBUw7.App\\Entity\\Printify\\Provider', NULL, 'Cannot autowire service ".service_locator.DhwBUw7": it references class "App\\Entity\\Printify\\Provider" but no such service exists.'],
        ], [
            'provider' => 'App\\Entity\\Printify\\Provider',
        ]);
    }

    /**
     * Gets the private '.service_locator.KyIg1jJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_KyIg1jJService()
    {
        return $this->privates['.service_locator.KyIg1jJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'product' => ['privates', '.errored..service_locator.KyIg1jJ.App\\Entity\\Printify\\Product', NULL, 'Cannot autowire service ".service_locator.KyIg1jJ": it references class "App\\Entity\\Printify\\Product" but no such service exists.'],
        ], [
            'product' => 'App\\Entity\\Printify\\Product',
        ]);
    }

    /**
     * Gets the private '.service_locator.Mhb1vdN' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Mhb1vdNService()
    {
        return $this->privates['.service_locator.Mhb1vdN'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'upload' => ['privates', '.errored..service_locator.Mhb1vdN.App\\Entity\\Printify\\Upload', NULL, 'Cannot autowire service ".service_locator.Mhb1vdN": it references class "App\\Entity\\Printify\\Upload" but no such service exists.'],
        ], [
            'upload' => 'App\\Entity\\Printify\\Upload',
        ]);
    }

    /**
     * Gets the private '.service_locator.PzX.2FJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_PzX_2FJService()
    {
        return $this->privates['.service_locator.PzX.2FJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\PrintifyController::printify_blueprintsselector' => ['privates', '.service_locator.RDavkXp', 'get_ServiceLocator_RDavkXpService', false],
            'App\\Controller\\PrintifyController::printify_createproduct' => ['privates', '.service_locator.ZEvxGHO', 'get_ServiceLocator_ZEvxGHOService', false],
            'App\\Controller\\PrintifyController::printify_productlist' => ['privates', '.service_locator.ZEvxGHO', 'get_ServiceLocator_ZEvxGHOService', false],
            'App\\Controller\\PrintifyController::printify_templateexporter' => ['privates', '.service_locator.u1Ce7KL', 'get_ServiceLocator_U1Ce7KLService', false],
            'App\\Controller\\PrintifyController::printify_uploadimage' => ['privates', '.service_locator.ZEvxGHO', 'get_ServiceLocator_ZEvxGHOService', false],
            'App\\Controller\\UserController::login' => ['privates', '.service_locator.q6jLs_L', 'get_ServiceLocator_Q6jLsLService', false],
            'App\\Controller\\UserController::register' => ['privates', '.service_locator.pfEGUEs', 'get_ServiceLocator_PfEGUEsService', false],
            'App\\Service\\Printify::blueprintforshop' => ['privates', '.service_locator.lbyCtSg', 'get_ServiceLocator_LbyCtSgService', false],
            'App\\Service\\Printify::createproduct' => ['privates', '.service_locator.utw1Mbu', 'get_ServiceLocator_Utw1MbuService', false],
            'App\\Service\\Printify::saveBlueprint' => ['privates', '.service_locator.v3h5JNi', 'get_ServiceLocator_V3h5JNiService', false],
            'App\\Service\\Printify::saveImage' => ['privates', '.service_locator.V5GWown', 'get_ServiceLocator_V5GWownService', false],
            'App\\Service\\Printify::saveLocation' => ['privates', '.service_locator.c2h_Yio', 'get_ServiceLocator_C2hYioService', false],
            'App\\Service\\Printify::saveMockup' => ['privates', '.service_locator.bfQkqF7', 'get_ServiceLocator_BfQkqF7Service', false],
            'App\\Service\\Printify::savePlaceholder' => ['privates', '.service_locator.oWQ8.ze', 'get_ServiceLocator_OWQ8_ZeService', false],
            'App\\Service\\Printify::savePrintarea' => ['privates', '.service_locator.lLiZ6ss', 'get_ServiceLocator_LLiZ6ssService', false],
            'App\\Service\\Printify::saveProduct' => ['privates', '.service_locator.KyIg1jJ', 'get_ServiceLocator_KyIg1jJService', false],
            'App\\Service\\Printify::saveProfile' => ['privates', '.service_locator.szmY7ZJ', 'get_ServiceLocator_SzmY7ZJService', false],
            'App\\Service\\Printify::saveProvider' => ['privates', '.service_locator.DhwBUw7', 'get_ServiceLocator_DhwBUw7Service', false],
            'App\\Service\\Printify::saveShipping' => ['privates', '.service_locator.j3WhcHr', 'get_ServiceLocator_J3WhcHrService', false],
            'App\\Service\\Printify::saveUpload' => ['privates', '.service_locator.Mhb1vdN', 'get_ServiceLocator_Mhb1vdNService', false],
            'App\\Service\\Printify::saveVariant' => ['privates', '.service_locator.dgbBq1k', 'get_ServiceLocator_DgbBq1kService', false],
            'App\\Controller\\PrintifyController:printify_blueprintsselector' => ['privates', '.service_locator.RDavkXp', 'get_ServiceLocator_RDavkXpService', false],
            'App\\Controller\\PrintifyController:printify_createproduct' => ['privates', '.service_locator.ZEvxGHO', 'get_ServiceLocator_ZEvxGHOService', false],
            'App\\Controller\\PrintifyController:printify_productlist' => ['privates', '.service_locator.ZEvxGHO', 'get_ServiceLocator_ZEvxGHOService', false],
            'App\\Controller\\PrintifyController:printify_templateexporter' => ['privates', '.service_locator.u1Ce7KL', 'get_ServiceLocator_U1Ce7KLService', false],
            ...
            'App\\Controller\\PrintifyController::printify_blueprintsselector' => '?',
            'App\\Controller\\PrintifyController::printify_createproduct' => '?',
            'App\\Controller\\PrintifyController::printify_productlist' => '?',
            'App\\Controller\\PrintifyController::printify_templateexporter' => '?',
            'App\\Controller\\PrintifyController::printify_uploadimage' => '?',
            'App\\Controller\\UserController::login' => '?',
            'App\\Controller\\UserController::register' => '?',
            'App\\Service\\Printify::blueprintforshop' => '?',
            'App\\Service\\Printify::createproduct' => '?',
            'App\\Service\\Printify::saveBlueprint' => '?',
            'App\\Service\\Printify::saveImage' => '?',
            'App\\Service\\Printify::saveLocation' => '?',
            'App\\Service\\Printify::saveMockup' => '?',
            'App\\Service\\Printify::savePlaceholder' => '?',
            'App\\Service\\Printify::savePrintarea' => '?',
            'App\\Service\\Printify::saveProduct' => '?',
            'App\\Service\\Printify::saveProfile' => '?',
            'App\\Service\\Printify::saveProvider' => '?',
            'App\\Service\\Printify::saveShipping' => '?',
            'App\\Service\\Printify::saveUpload' => '?',
            'App\\Service\\Printify::saveVariant' => '?',
            'App\\Controller\\PrintifyController:printify_blueprintsselector' => '?',
            'App\\Controller\\PrintifyController:printify_createproduct' => '?',
            'App\\Controller\\PrintifyController:printify_productlist' => '?',
            'App\\Controller\\PrintifyController:printify_templateexporter' => '?',
    ...
    /**
     * Gets the private '.service_locator.RDavkXp' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RDavkXpService()
    {
        return $this->privates['.service_locator.RDavkXp'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'paginator' => ['services', 'knp_paginator', 'getKnpPaginatorService', false],
            'selectedShop' => ['privates', '.errored..service_locator.RDavkXp.App\\Entity\\Printify\\Shop', NULL, 'Cannot autowire service ".service_locator.RDavkXp": it references class "App\\Entity\\Printify\\Shop" but no such service exists.'],
        ], [
            'paginator' => '?',
            'selectedShop' => 'App\\Entity\\Printify\\Shop',
        ]);
    }

    /**
     * Gets the private '.service_locator.V5GWown' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_V5GWownService()
    {
        return $this->privates['.service_locator.V5GWown'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'image' => ['privates', '.errored..service_locator.V5GWown.App\\Entity\\Printify\\Image', NULL, 'Cannot autowire service ".service_locator.V5GWown": it references class "App\\Entity\\Printify\\Image" but no such service exists.'],
        ], [
            'image' => 'App\\Entity\\Printify\\Image',
        ]);
    }

    /**
     * Gets the private '.service_locator.ZEvxGHO' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_ZEvxGHOService()
    {
        return $this->privates['.service_locator.ZEvxGHO'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'shop' => ['privates', '.errored..service_locator.ZEvxGHO.App\\Entity\\Printify\\Shop', NULL, 'Cannot autowire service ".service_locator.ZEvxGHO": it references class "App\\Entity\\Printify\\Shop" but no such service exists.'],
        ], [
            'shop' => 'App\\Entity\\Printify\\Shop',
        ]);
    }

    /**
     * Gets the private '.service_locator.bfQkqF7' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_BfQkqF7Service()
    {
        return $this->privates['.service_locator.bfQkqF7'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'mockup' => ['privates', '.errored..service_locator.bfQkqF7.App\\Entity\\Printify\\Mockup', NULL, 'Cannot autowire service ".service_locator.bfQkqF7": it references class "App\\Entity\\Printify\\Mockup" but no such service exists.'],
        ], [
            'mockup' => 'App\\Entity\\Printify\\Mockup',
        ]);
    }

    /**
     * Gets the private '.service_locator.c2h_Yio' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_C2hYioService()
    {
        return $this->privates['.service_locator.c2h_Yio'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'location' => ['privates', '.errored..service_locator.c2h_Yio.App\\Entity\\Printify\\Location', NULL, 'Cannot autowire service ".service_locator.c2h_Yio": it references class "App\\Entity\\Printify\\Location" but no such service exists.'],
        ], [
            'location' => 'App\\Entity\\Printify\\Location',
        ]);
    }

    /**
     * Gets the private '.service_locator.dgbBq1k' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DgbBq1kService()
    {
        return $this->privates['.service_locator.dgbBq1k'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'variant' => ['privates', '.errored..service_locator.dgbBq1k.App\\Entity\\Printify\\Variant', NULL, 'Cannot autowire service ".service_locator.dgbBq1k": it references class "App\\Entity\\Printify\\Variant" but no such service exists.'],
        ], [
            'variant' => 'App\\Entity\\Printify\\Variant',
        ]);
    }

    /**
     * Gets the private '.service_locator.j3WhcHr' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_J3WhcHrService()
    {
        return $this->privates['.service_locator.j3WhcHr'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'shipping' => ['privates', '.errored..service_locator.j3WhcHr.App\\Entity\\Printify\\Shipping', NULL, 'Cannot autowire service ".service_locator.j3WhcHr": it references class "App\\Entity\\Printify\\Shipping" but no such service exists.'],
        ], [
            'shipping' => 'App\\Entity\\Printify\\Shipping',
        ]);
    }

    /**
     * Gets the private '.service_locator.lLiZ6ss' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LLiZ6ssService()
    {
        return $this->privates['.service_locator.lLiZ6ss'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'print_area' => ['privates', '.errored..service_locator.lLiZ6ss.App\\Entity\\Printify\\Printarea', NULL, 'Cannot autowire service ".service_locator.lLiZ6ss": it references class "App\\Entity\\Printify\\Printarea" but no such service exists.'],
        ], [
            'print_area' => 'App\\Entity\\Printify\\Printarea',
        ]);
    }

    /**
     * Gets the private '.service_locator.lbyCtSg' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LbyCtSgService()
    {
        return $this->privates['.service_locator.lbyCtSg'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'blueprint' => ['privates', '.errored..service_locator.lbyCtSg.App\\Entity\\Printify\\Blueprint', NULL, 'Cannot autowire service ".service_locator.lbyCtSg": it references class "App\\Entity\\Printify\\Blueprint" but no such service exists.'],
            'shop' => ['privates', '.errored..service_locator.lbyCtSg.App\\Entity\\Printify\\Shop', NULL, 'Cannot autowire service ".service_locator.lbyCtSg": it references class "App\\Entity\\Printify\\Shop" but no such service exists.'],
        ], [
            'blueprint' => 'App\\Entity\\Printify\\Blueprint',
            'shop' => 'App\\Entity\\Printify\\Shop',
        ]);
    }

    /**
     * Gets the private '.service_locator.oWQ8.ze' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_OWQ8_ZeService()
    {
        return $this->privates['.service_locator.oWQ8.ze'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'placeholder' => ['privates', '.errored..service_locator.oWQ8.ze.App\\Entity\\Printify\\Placeholder', NULL, 'Cannot autowire service ".service_locator.oWQ8.ze": it references class "App\\Entity\\Printify\\Placeholder" but no such service exists.'],
        ], [
            'placeholder' => 'App\\Entity\\Printify\\Placeholder',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.pfEGUEs' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_PfEGUEsService()
    {
        return $this->privates['.service_locator.pfEGUEs'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.szmY7ZJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SzmY7ZJService()
    {
        return $this->privates['.service_locator.szmY7ZJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'profile' => ['privates', '.errored..service_locator.szmY7ZJ.App\\Entity\\Printify\\Profile', NULL, 'Cannot autowire service ".service_locator.szmY7ZJ": it references class "App\\Entity\\Printify\\Profile" but no such service exists.'],
        ], [
            'profile' => 'App\\Entity\\Printify\\Profile',
        ]);
    }

    /**
     * Gets the private '.service_locator.u1Ce7KL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_U1Ce7KLService()
    {
        return $this->privates['.service_locator.u1Ce7KL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'selectedShop' => ['privates', '.errored..service_locator.u1Ce7KL.App\\Entity\\Printify\\Shop', NULL, 'Cannot autowire service ".service_locator.u1Ce7KL": it references class "App\\Entity\\Printify\\Shop" but no such service exists.'],
        ], [
            'selectedShop' => 'App\\Entity\\Printify\\Shop',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.utw1Mbu' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Utw1MbuService()
    {
        return $this->privates['.service_locator.utw1Mbu'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'producttocreate' => ['privates', '.errored..service_locator.utw1Mbu.App\\Entity\\Printify\\Product', NULL, 'Cannot autowire service ".service_locator.utw1Mbu": it references class "App\\Entity\\Printify\\Product" but no such service exists.'],
        ], [
            'producttocreate' => 'App\\Entity\\Printify\\Product',
        ]);
    }

    /**
     * Gets the private '.service_locator.v3h5JNi' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_V3h5JNiService()
    {
        return $this->privates['.service_locator.v3h5JNi'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'blueprint' => ['privates', '.errored..service_locator.v3h5JNi.App\\Entity\\Printify\\Blueprint', NULL, 'Cannot autowire service ".service_locator.v3h5JNi": it references class "App\\Entity\\Printify\\Blueprint" but no such service exists.'],
        ], [
            'blueprint' => 'App\\Entity\\Printify\\Blueprint',
        ]);
    }
    ...
    /**
     * Gets the private 'App\Repository\Printful\AvailabilityStatusRepository' shared autowired service.
     *
     * @return \App\Repository\Printful\AvailabilityStatusRepository
     */
    protected function getAvailabilityStatusRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printful\\AvailabilityStatusRepository.php';

        return $this->privates['App\\Repository\\Printful\\AvailabilityStatusRepository'] = new \App\Repository\Printful\AvailabilityStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printful\FileTypeRepository' shared autowired service.
     *
     * @return \App\Repository\Printful\FileTypeRepository
     */
    protected function getFileTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printful\\FileTypeRepository.php';

        return $this->privates['App\\Repository\\Printful\\FileTypeRepository'] = new \App\Repository\Printful\FileTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printful\OptionTypeRepository' shared autowired service.
     *
     * @return \App\Repository\Printful\OptionTypeRepository
     */
    protected function getOptionTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printful\\OptionTypeRepository.php';

        return $this->privates['App\\Repository\\Printful\\OptionTypeRepository'] = new \App\Repository\Printful\OptionTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printful\ProductRepository' shared autowired service.
     *
     * @return \App\Repository\Printful\ProductRepository
     */
    protected function getProductRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printful\\ProductRepository.php';

        return $this->privates['App\\Repository\\Printful\\ProductRepository'] = new \App\Repository\Printful\ProductRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printful\VariantRepository' shared autowired service.
     *
     * @return \App\Repository\Printful\VariantRepository
     */
    protected function getVariantRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printful\\VariantRepository.php';

        return $this->privates['App\\Repository\\Printful\\VariantRepository'] = new \App\Repository\Printful\VariantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\BlueprintRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\BlueprintRepository
     */
    protected function getBlueprintRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\BlueprintRepository.php';

        return $this->privates['App\\Repository\\Printify\\BlueprintRepository'] = new \App\Repository\Printify\BlueprintRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ImageRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ImageRepository
     */
    protected function getImageRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ImageRepository.php';

        return $this->privates['App\\Repository\\Printify\\ImageRepository'] = new \App\Repository\Printify\ImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\LocationRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\LocationRepository
     */
    protected function getLocationRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\LocationRepository.php';

        return $this->privates['App\\Repository\\Printify\\LocationRepository'] = new \App\Repository\Printify\LocationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\MockupRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\MockupRepository
     */
    protected function getMockupRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\MockupRepository.php';

        return $this->privates['App\\Repository\\Printify\\MockupRepository'] = new \App\Repository\Printify\MockupRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\PlaceholderRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\PlaceholderRepository
     */
    protected function getPlaceholderRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\PlaceholderRepository.php';

        return $this->privates['App\\Repository\\Printify\\PlaceholderRepository'] = new \App\Repository\Printify\PlaceholderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\PrintareaRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\PrintareaRepository
     */
    protected function getPrintareaRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\PrintareaRepository.php';

        return $this->privates['App\\Repository\\Printify\\PrintareaRepository'] = new \App\Repository\Printify\PrintareaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ProductRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ProductRepository
     */
    protected function getProductRepository2Service()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ProductRepository.php';

        return $this->privates['App\\Repository\\Printify\\ProductRepository'] = new \App\Repository\Printify\ProductRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ProfileRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ProfileRepository
     */
    protected function getProfileRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ProfileRepository.php';

        return $this->privates['App\\Repository\\Printify\\ProfileRepository'] = new \App\Repository\Printify\ProfileRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ProviderRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ProviderRepository
     */
    protected function getProviderRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ProviderRepository.php';

        return $this->privates['App\\Repository\\Printify\\ProviderRepository'] = new \App\Repository\Printify\ProviderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\PublishingRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\PublishingRepository
     */
    protected function getPublishingRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\PublishingRepository.php';

        return $this->privates['App\\Repository\\Printify\\PublishingRepository'] = new \App\Repository\Printify\PublishingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ShippingRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ShippingRepository
     */
    protected function getShippingRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ShippingRepository.php';

        return $this->privates['App\\Repository\\Printify\\ShippingRepository'] = new \App\Repository\Printify\ShippingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\ShopRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\ShopRepository
     */
    protected function getShopRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\ShopRepository.php';

        return $this->privates['App\\Repository\\Printify\\ShopRepository'] = new \App\Repository\Printify\ShopRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\UploadRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\UploadRepository
     */
    protected function getUploadRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\UploadRepository.php';

        return $this->privates['App\\Repository\\Printify\\UploadRepository'] = new \App\Repository\Printify\UploadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\Printify\VariantRepository' shared autowired service.
     *
     * @return \App\Repository\Printify\VariantRepository
     */
    protected function getVariantRepository2Service()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\Printify\\VariantRepository.php';

        return $this->privates['App\\Repository\\Printify\\VariantRepository'] = new \App\Repository\Printify\VariantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kv5lf0H5Hi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+LsZ1TuUMI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GV6223cwMH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zCNnpUnmyH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G07bk-b7Kg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('spBuYBOrLe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.PzX.2FJ'] ?? $this->get_ServiceLocator_PzX_2FJService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pod/printify'), [0 => 'ROLE_PRINTIFY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pod/printful'), [0 => 'ROLE_PRINTFUL'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/shop/shopify'), [0 => 'ROLE_SHOPIFY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/shop/woocommerce'), [0 => 'ROLE_WOOCOMMERCE'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tools/spinning'), [0 => 'ROLE_SPINNING'], NULL);
